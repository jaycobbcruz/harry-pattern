...
public class Category {
	private static final Logger log = LoggerFactory.getLogger(org.alicebot.ab.Category.class);
     ...
     */
    public static org.alicebot.ab.Category IFToCategory(String IF) {
        String[] split = IF.split(MagicStrings.aimlif_split_char);
        //log.info("Read: "+split);
        return new org.alicebot.ab.Category(Integer.parseInt(split[0]), split[1], split[2], split[3], lineToTemplate(split[4]), split[5]);
     }
     ...
     */
    public static String categoryToIF(org.alicebot.ab.Category category) {
     ...
     */
    public static String categoryToAIML(org.alicebot.ab.Category category) {
     ...
     */
    public static Comparator<org.alicebot.ab.Category> ACTIVATION_COMPARATOR = new Comparator<org.alicebot.ab.Category>()
    {
        @Override
		public int compare(org.alicebot.ab.Category c1, org.alicebot.ab.Category c2)
        {
     ...
     */
    public static Comparator<org.alicebot.ab.Category> PATTERN_COMPARATOR = new Comparator<org.alicebot.ab.Category>()
    {
        @Override
		public int compare(org.alicebot.ab.Category c1, org.alicebot.ab.Category c2)
        {
     ...
     */
    public static Comparator<org.alicebot.ab.Category> CATEGORY_NUMBER_COMPARATOR = new Comparator<org.alicebot.ab.Category>()
    {
        @Override
		public int compare(org.alicebot.ab.Category c1, org.alicebot.ab.Category c2)
        {
