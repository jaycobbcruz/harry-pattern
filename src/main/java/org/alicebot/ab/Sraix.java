...
public class Sraix {
	...
	private static final Logger log = LoggerFactory.getLogger(org.alicebot.ab.Sraix.class);
    ...
    public static String sraix(org.alicebot.ab.Chat chatSession, String input, String defaultResponse, String hint, String host, String botid, String apiKey, String limit) {
        String response;
    ...
    public static String sraixPandorabots(String input, org.alicebot.ab.Chat chatSession, String host, String botid) {
    ...
    public static String pandorabotsResponse (String sraixResponse, org.alicebot.ab.Chat chatSession, String host, String botid) {
