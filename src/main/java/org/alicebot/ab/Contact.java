...
public class Contact {
	private static final Logger log = LoggerFactory.getLogger(org.alicebot.ab.Contact.class);
    public static int contactCount=0;
    public static HashMap<String, org.alicebot.ab.Contact> idContactMap = new HashMap<String, org.alicebot.ab.Contact>();
    ...
    public static String displayName(String id) {
        org.alicebot.ab.Contact c = idContactMap.get(id.toUpperCase());
        String result = "unknown";
        if (c != null) {
