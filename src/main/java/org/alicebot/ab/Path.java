...
public class Path extends ArrayList<String>{
	private static final Logger log = LoggerFactory.getLogger(org.alicebot.ab.Path.class);
    public String word;
    public org.alicebot.ab.Path next;
    public int length;
     ...
     */
    public static org.alicebot.ab.Path sentenceToPath(String sentence) {
     ...
     * @return               sentence
     */
    public static String pathToSentence (org.alicebot.ab.Path path) {
        String result="";
        for (org.alicebot.ab.Path p = path; p != null; p = p.next) {
     ...
     */
    private static org.alicebot.ab.Path arrayToPath(String[] array) {
        org.alicebot.ab.Path tail = null;
        org.alicebot.ab.Path head = null;
        for (int i = array.length-1; i >= 0; i--) {
            head = new org.alicebot.ab.Path();
            head.word = array[i];
            head.next = tail;
     ...
     * @return       Path form
     */
    private static org.alicebot.ab.Path arrayToPath(String[] array, int index)  {
        if (index >= array.length) return null;
        else {
            org.alicebot.ab.Path newPath = new org.alicebot.ab.Path();
    ...
    public void print() {
        String result = "";
        for (org.alicebot.ab.Path p = this; p != null; p = p.next) {
            result += p.word+",";
        }
