 ...
 */
public class Bot {
    private static final Logger log = LoggerFactory.getLogger(org.alicebot.ab.Bot.class);
    public final org.alicebot.ab.Properties properties = new org.alicebot.ab.Properties();
    ...
    void addCategoriesFromAIML() {
        org.alicebot.ab.Timer timer = new org.alicebot.ab.Timer();
        timer.start();
        try {
            // Directory path here
            String file;
