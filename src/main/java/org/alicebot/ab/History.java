...
public class History<T> {
    ...
    public History(String name) {
        this.name = name;
        history = new Object[org.alicebot.ab.MagicNumbers.max_history];
    }
    ...
    public void add(T item) {
        for (int i = org.alicebot.ab.MagicNumbers.max_history-1; i > 0; i--) {
    ...
    public T get (int index) {
        if (index < org.alicebot.ab.MagicNumbers.max_history) {
    ...
    public void printHistory() {
        ...
        for (i = 0; get(i) != null; i++) {
            ...
            if (String.valueOf(get(i).getClass()).contains("History")) ((org.alicebot.ab.History)get(i)).printHistory();
        }
    }
}
